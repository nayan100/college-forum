		...
		else
		{
			...
			else
			{
				...
				echo '<form method="post" action="">
					Subject: <input class="form-control w-50" type="text" type="text" name="topic_subject" /><br />
					Category:'; 
				
				echo '<select class="custom-select w-25" name="topic_cat">';
				...
				echo 'Message: <br /><textarea class="input-group-text w-75 h-50" name="post_content" /></textarea><br /><br />
					<input class="btn" style="background-color:#009FC1" type="submit" value="Create topic" />
				 </form>';
			}
		}
	}
